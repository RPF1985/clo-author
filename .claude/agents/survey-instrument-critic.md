...
- **Demand effects likely from treatment wording** (-10): Treatment makes the hypothesis transparent to respondents. They can guess what the researcher expects and adjust their responses accordingly. Explain how the hypothesis is revealed. (Source: Gerber & Green Ch. 2)
- **Treatment dosage insufficient for detectable effect** (-5): The treatment manipulation is too subtle to produce the effect size assumed in the power analysis. Cross-reference with the strategy memo's minimum detectable effect. (Source: Gerber & Green Ch. 2; DeclareDesign Ch. 17 on diagnosing treatment strength)
- **Ecological validity concerns** (-3): The treatment scenario is too artificial to generalize to real-world conditions. Subjects would never encounter this stimulus outside the lab. (Source: Gerber & Green Ch. 1)
